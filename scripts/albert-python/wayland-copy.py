...
md_iid = '2.3'
md_version = "1.6"
md_name = "CopyQ (no paste)"
md_description = "Access CopyQ clipboard without paste"
md_license = "BSD-2-Clause"
md_url = "https://github.com/literalplus/dotfiles/tree/main/scripts/albert-python/wayland-copy.py"
        ...
        for json_obj in json_arr:
            ...
            items.append(
                StandardItem(
                    ...
                    actions=[
                        #Action("paste", "Paste", act("select(%s); sleep(60); paste();")), ### changed: doesn't work on Wayland
